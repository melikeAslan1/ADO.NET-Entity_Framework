  ...
  public class InitDB: DropCreateDatabaseAlways<FilmDB>         
    {
        ...
        {
            context.Yonetmenler.Add(new Model.Yonetmen { YonetmenAdi = "Spielberg" });

            context.Yonetmenler.Add(new Model.Yonetmen { YonetmenAdi = "Fincher" });
            ...
            context.Film_Oyuncu.Add(new Film_Oyuncu { FilmID = 2, OyuncuID = 4, RolAdi = "Michael" });
